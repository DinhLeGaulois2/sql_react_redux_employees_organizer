...
LinkEmp2DptComponent.propTypes = {
}
...
LinkEmp2DptComponent = reduxForm({
    form: 'SSSSSSSSForm',
    validate,
    onSubmitSuccess: afterSubmit
})(LinkEmp2DptComponent)

// Decorate with connect to read form values
const selector = formValueSelector('SSSSSSSSForm') // <-- same as form name
LinkEmp2DptComponent = connect(
    state => {
...
export default LinkEmp2DptComponent
